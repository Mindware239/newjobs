    ...
    <div class="container mx-auto px-4 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav class="hidden lg:flex items-center gap-4">
            <div class="relative" x-data="{ open:false }" @mouseenter="open=true" @mouseleave="open=false">
                ...
                <div x-show="open" x-transition class="absolute left-0 top-full mt-2 w-[1100px] bg-white rounded-xl shadow-xl border border-gray-200 p-8 z-50" style="display:none">
                    <div class="flex divide-x divide-gray-200">
                        <div class="flex-1 pr-10">
                            <div class="text-sm font-bold text-gray-900 mb-4">Popular categories</div>
                            <ul class="space-y-3 text-sm">
                                <?php foreach ($popularCategories as $item): ?>
                                    <li><a href="<?php echo $base . $item['url']; ?>" class="block whitespace-nowrap text-gray-600 hover:text-blue-600 hover:font-medium transition-colors"><?php echo htmlspecialchars($item['label']); ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <div class="flex-1 px-10">
                            <div class="text-sm font-bold text-gray-900 mb-4">Jobs in demand</div>
                            <ul class="space-y-3 text-sm">
                        ...
                        <div class="flex-1 pl-10">
                            <div class="text-sm font-bold text-gray-900 mb-4">Jobs by location</div>
                            <ul class="space-y-3 text-sm">
            ...
            <a href="<?php echo $base; ?>company/featured" class="flex items-center gap-2 px-4 py-2 rounded-lg text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition bg-white">Companies</a>
            <!-- <a href="<?php //echo $base; ?>blog" class="text-gray-800 hover:text-blue-600 font-medium">Blogs</a> -->
         
            <a href="<?php echo $base; ?>social-services" class="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 text-gray-700 font-medium hover:border-blue-600 hover:text-blue-600 transition bg-white" target="_blank">Social Services Jobs</a>
