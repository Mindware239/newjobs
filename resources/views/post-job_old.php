                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <span x-show="locationLoading"
                                      class="ml-2 text-xs text-gray-500">Detecting location...</span>
                            </label>
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                    <span x-show="formData.location.state && formData.location.city">
                                        Selected: <strong
                                                x-text="formData.location.city + ', ' + formData.location.state"></strong>
                                    </span>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                Use the toolbar above to format your job description. You can add bullet points, bold
                                text, and more.
                            </p>
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" x-model="formData.job_timings"
                                   ...
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                            <p class="text-xs text-gray-500 mt-1">Please mention job timings correctly otherwise
                                candidates may not join</p>
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Please fill complete address, mention Landmark near
                                your office</p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-2">
                            <div>
                                ...
                                <p class="text-lg font-semibold"
                                   x-text="formData.salary_min ? '₹' + formData.salary_min : '--'"></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600">Maximum Salary</p>
                                <p class="text-lg font-semibold"
                                   x-text="formData.salary_max ? '₹' + formData.salary_max : '--'"></p>
                            </div>
                        </div>
                    </div>
                </div>
