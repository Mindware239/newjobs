...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;}
        ...
        body{font-family:'Plus Jakarta Sans',-apple-system,BlinkMacSystemFont,sans-serif;background:#fff;}
        ...
        .b1{width:300px;height:300px;top:-70px;left:-70px;background:rgba(99,102,241,.14);
            animation:bfloat 14s ease-in-out infinite;}
        .b2{width:220px;height:220px;top:40%;right:-55px;background:rgba(59,130,246,.11);
            animation:bfloat 10s ease-in-out infinite reverse;}
        .b3{width:160px;height:160px;bottom:-30px;left:20%;background:rgba(139,92,246,.1);
            animation:bfloat 17s ease-in-out 5s infinite;}
        @keyframes bfloat{
            0%,100%{transform:translate(0,0) scale(1);}
            33%{transform:translate(20px,-18px) scale(1.04);}
            66%{transform:translate(-15px,22px) scale(.96);}
        }
        ...
        /* Logo */
        .l-logo{display:flex;align-items:center;gap:10px;flex-shrink:0;}
        .l-logo-mark{
        ...
        .l-logo-name{font-weight:700;font-size:15px;color:#1e1b4b;letter-spacing:-.2px;}
        ...
        .slides-grid{display:grid;position:relative;}
        .slide{
            grid-area:1/1;
        ...
        .slide.exiting{opacity:0;transform:translateX(-48px);}
        ...
        .s-badge{
            ...
            font-size:11px;font-weight:600;color:#4338ca;letter-spacing:.5px;text-transform:uppercase;
        }
        .s-pulse{
        ...
        .s-title{
            ...
            color:#1e1b4b;line-height:1.2;letter-spacing:-.6px;
        }
        .s-title .acc{
            background:linear-gradient(135deg,#4f46e5,#3b82f6);
        ...
        .s-desc{font-size:13.5px;color:#4b5563;line-height:1.65;max-width:340px;}

        /* Stat cards */
        .stat-row{display:flex;gap:10px;}
        .stat-c{
            flex:1;background:rgba(255,255,255,.9);border:1px solid rgba(199,210,254,.8);
            border-radius:12px;padding:12px 14px;backdrop-filter:blur(4px);
        }
        .stat-v{font-size:20px;font-weight:800;color:#1e1b4b;}
        .stat-v span{color:#4f46e5;}
        .stat-l{font-size:11px;color:#9ca3af;margin-top:1px;}

        /* Feature rows */
        .feat-wrap{
            border-top:1px solid rgba(199,210,254,.5);
            padding-top:12px;display:flex;flex-direction:column;gap:1px;
        }
        .feat-row{display:flex;align-items:center;gap:10px;padding:6px 0;font-size:13px;color:#374151;}
        .feat-ic{width:28px;height:28px;border-radius:7px;display:flex;align-items:center;justify-content:center;font-size:13px;flex-shrink:0;}

        /* Company cards */
        .co-wrap{display:flex;flex-direction:column;gap:8px;}
        .co-card{
            background:rgba(255,255,255,.88);border:1px solid rgba(199,210,254,.8);
            border-radius:11px;padding:10px 13px;
            display:flex;align-items:center;gap:10px;
            backdrop-filter:blur(4px);
        }
        .co-logo{width:34px;height:34px;border-radius:9px;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:800;color:white;flex-shrink:0;}
        .co-name{font-size:12.5px;font-weight:700;color:#111827;}
        .co-sub{font-size:11px;color:#6b7280;margin-top:1px;}
        .co-tag{margin-left:auto;font-size:10px;font-weight:700;padding:3px 9px;border-radius:100px;white-space:nowrap;}
        .co-tag.premium{background:#eff6ff;color:#1d4ed8;border:1px solid #bfdbfe;}
        .co-tag.verified{background:#ecfdf5;color:#059669;border:1px solid #a7f3d0;}

        /* Nav */
        .s-nav{display:flex;align-items:center;gap:14px;margin-top:18px;}
        .s-dots{display:flex;gap:6px;flex:1;}
        .s-dot{height:4px;border-radius:2px;background:rgba(79,70,229,.18);cursor:pointer;transition:all .4s;flex:1;max-width:36px;}
        .s-dot.active{background:#4f46e5;max-width:50px;box-shadow:0 0 8px rgba(79,70,229,.35);}
        .s-arrows{display:flex;gap:7px;}
        .s-arr{
            width:32px;height:32px;border-radius:50%;background:white;
            border:1.5px solid #e0e7ff;color:#4338ca;cursor:pointer;
            display:flex;align-items:center;justify-content:center;
            transition:all .2s;box-shadow:0 1px 5px rgba(79,70,229,.07);
        }
        .s-arr:hover{background:#eef2ff;border-color:#c7d2fe;transform:scale(1.07);}
        .s-arr svg{width:14px;height:14px;}
        .s-prog{height:3px;background:rgba(79,70,229,.1);border-radius:2px;overflow:hidden;margin-top:9px;}
        .s-prog-bar{height:100%;background:linear-gradient(90deg,#4f46e5,#3b82f6);border-radius:2px;transition:width .1s linear;}
        ...
        .right-panel{
            ...
            padding:40px 52px;overflow-y:auto;min-height:100vh;
        }
        .r-box{
        ...
        .back-lnk:hover{color:#374151;}
        .back-lnk svg{width:14px;height:14px;}

        /* Brand */
        .brand-row{display:flex;align-items:center;gap:11px;margin-bottom:20px;}
        .brand-mark{
        ...
        /* Headings */
        .r-h1{font-size:23px;font-weight:800;color:#111827;letter-spacing:-.5px;margin:0 0 3px;}
        .r-sub{font-size:13px;color:#6b7280;margin:0 0 22px;}
        ...
        .fl{display:block;font-size:12px;font-weight:600;color:#374151;margin-bottom:5px;}
        .fl .req{color:#ef4444;}
        ...
        .fi:focus{border-color:#4f46e5;background:#fff;box-shadow:0 0 0 3px rgba(79,70,229,.1);}
        .fi.ok{border-color:#22c55e;background:#fff;}
        .fi.err{border-color:#ef4444;}
        .fi.has-icon{padding-right:42px;}

        .eye-btn{
            position:absolute;right:11px;top:50%;transform:translateY(-50%);
            background:none;border:none;cursor:pointer;color:#9ca3af;
            transition:color .2s;padding:3px;display:flex;line-height:1;
        }
        ...
        .str-fill{height:100%;border-radius:2px;transition:all .35s ease;}
        .str-row{display:flex;align-items:center;justify-content:space-between;}
        .str-lbl{font-size:11.5px;font-weight:600;}
        .str-chars{font-size:11px;color:#9ca3af;}
        ...
        .req-head{font-size:11.5px;font-weight:700;color:#374151;margin-bottom:7px;}
        .rq{
            display:flex;align-items:center;font-size:12px;
            margin-bottom:4px;transition:color .2s;color:#9ca3af;gap:7px;
        }
        ...
        .rq.met .rq-ic{background:#22c55e;color:white;}
        .rq:not(.met) .rq-ic{background:#e5e7eb;color:#9ca3af;}
        ...
        .sug-ttl{font-size:11.5px;font-weight:700;color:#1d4ed8;margin-bottom:3px;}
        .sug-list{padding-left:13px;margin:0;}
        .sug-list li{font-size:11px;color:#1d4ed8;margin-bottom:2px;}

        /* Divider */
        .divider{display:flex;align-items:center;gap:10px;margin:14px 0;}
        .div-line{flex:1;height:1px;background:#f1f5f9;}
        .div-txt{font-size:11.5px;color:#d1d5db;font-weight:500;white-space:nowrap;}

        /* Social */
        .soc-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin-bottom:14px;}
        .soc-btn{
            display:flex;align-items:center;justify-content:center;
            padding:9px;border:1.5px solid #e5e7eb;border-radius:9px;
            background:white;text-decoration:none;transition:all .18s;
        }
        ...
        /* Terms */
        .terms-row{display:flex;align-items:flex-start;gap:9px;margin-bottom:15px;}
        .terms-cb{width:14px;height:14px;margin-top:2px;flex-shrink:0;accent-color:#4f46e5;cursor:pointer;}
        ...
        .sub-btn:hover:not(:disabled){transform:translateY(-2px);box-shadow:0 8px 24px rgba(79,70,229,.36);}
        .sub-btn:disabled{opacity:.5;cursor:not-allowed;transform:none;box-shadow:none;}
        .sub-btn svg{width:16px;height:16px;}
        .spin{width:16px;height:16px;border:2px solid rgba(255,255,255,.3);border-top-color:white;border-radius:50%;animation:spinr .7s linear infinite;}
        @keyframes spinr{to{transform:rotate(360deg);}}

        .r-footer{text-align:center;font-size:12.5px;color:#6b7280;}
        .r-footer a{font-weight:700;color:#4f46e5;text-decoration:none;}
        .r-footer a:hover{color:#4338ca;text-decoration:underline;}
    </style>
</head>
<body>
    ...
    <div class="left-panel">
        ...
        <div class="l-inner">
            ...
            <div class="slider-wrap">
                ...
                <div class="s-prog"><div class="s-prog-bar" id="progBar" style="width:0%"></div></div>
                <div class="s-nav">
                    <div class="s-dots">
            ...
            async submitRegistration() {
                ...
                try {
                    ...
                    if (isSuccess) {
                        ...
                        const errorMsg = errorData.error || errorData.message || errorData.errors || 'Registration failed';
