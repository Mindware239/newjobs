...
<body class="min-h-screen">
    <div x-data="employerRegistrationForm()" x-cloak class="grid grid-cols-1 md:grid-cols-2 md:gap-8 min-h-screen">
        ...
        function employerRegistrationForm() {
            return {
                ...
                async submitRegistration() {
                    ...
                    this.validateEmail(); this.checkPasswordStrength(); this.validatePasswordMatch();
    ...
    <div x-data="window.registrationForm()" x-cloak x-show="false" class="min-h-screen flex flex-col">
                            ...
                            <div x-show="currentStep === 2" x-transition>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" x-model="formData.address.street"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" x-model="formData.address.city"
                                                placeholder="City"
                                                class="w-full pl-10 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition">
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" x-model="formData.address.state"
                                                placeholder="State"
                                                class="w-full pl-10 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition">
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" x-model="formData.address.postal_code"
