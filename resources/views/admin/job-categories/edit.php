<div>
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Edit Job Category</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="/admin/job-categories/<?= $category['id'] ?>" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mb-3">
                        <img src="<?= htmlspecialchars($category['image']) ?>" alt="Current image" class="w-20 h-20 object-cover rounded border border-gray-300">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <label class="inline-flex items-center">
                                <input type="radio" name="is_active" value="1" <?= ($category['is_active'] ?? 1) ? 'checked' : '' ?> class="mr-2">
                                <span>Active</span>
                            </label>
                            <label class="inline-flex items-center ml-6">
                                <input type="radio" name="is_active" value="0" <?= !($category['is_active'] ?? 1) ? 'checked' : '' ?> class="mr-2">
                                <span>Inactive</span>
                            </label>
                        </div>
                    </div>
