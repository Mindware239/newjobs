<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Modify existing system permission details.
                </p>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                ...
                                Changing the <code>slug</code> may break existing code that relies on this specific permission key.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            ...
            <form method="post" action="/master/permissions/<?= $permission['id'] ?>/edit" class="shadow sm:rounded-md sm:overflow-hidden bg-white">
